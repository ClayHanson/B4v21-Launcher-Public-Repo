...
protected:
   ...
   enum MaskBits {
	  ...
	  FaceNameMask  = Parent::NextFreeMask << 3,
	  DecalNameMask = Parent::NextFreeMask << 4,
...
public:
   ...
   // IFL Customization
   void setFaceName(const char* name);
   void setDecalName(const char* name);
