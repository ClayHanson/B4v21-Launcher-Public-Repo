...
// TypeStringObject
//////////////////////////////////////////////////////////////////////////
ConsoleType( stringObject, TypeStringObject, sizeof(String) )

ConsoleSetType( TypeStringObject )
{
   if(argc == 1)
      *((String *) dptr) = argv[0];
   else
      Con::printf("(TypeStringObject) Cannot set multiple args to a single string.");
}

ConsoleGetType( TypeStringObject )
{
   return static_cast<String*>(dptr)->get();
}
