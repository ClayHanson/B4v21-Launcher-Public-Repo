...
public:
   ...
   enum PacketTypes
   {
      ...
      GameInfoResponse              = 20,
      GameHeartbeat                 = 22,
      SimplePingResponse            = 24,

	  PunchPacket                   = 42,
	  ArrangedConnectionNotify      = 48,
      ConnectChallengeRequest       = 28,
      ConnectChallengeReject        = 29,
...
protected:
   ...
   void handleArrangedConnectionNotify(const NetAddress* address, BitStream* stream);
   void handlePunchPacket(const NetAddress* address, BitStream* stream);
...
extern StringTableEntry gMatchMakerToken;
extern NetAddress gMatchMakerAddr;
#endif
