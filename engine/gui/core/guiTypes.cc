...
void GuiControlProfile::initPersistFields()
{
   ...
   addField("doFontOutline",		TypeBool,	Offset(mOutlineFont, GuiControlProfile));
   addField("fontOutlineWidth",		TypeS32,	Offset(mOutlineWidth, GuiControlProfile));
   addField("fontOutlineColor",		TypeColorI, Offset(mOutlineColor, GuiControlProfile));
   addField("fontOutlineColorHL",	TypeColorI, Offset(mOutlineColorHL, GuiControlProfile));
   addField("fontOutlineColorNA",	TypeColorI, Offset(mOutlineColorNA, GuiControlProfile));
   addField("fontOutlineColorSEL",	TypeColorI, Offset(mOutlineColorSEL, GuiControlProfile));
...
ConsoleMethod(GuiControlProfile, reConstructArray, S32, 2, 2, "") {
	object->mTextureHandle = TextureHandle(object->mBitmapName, BitmapKeepTexture);
	return object->constructBitmapArray();
}