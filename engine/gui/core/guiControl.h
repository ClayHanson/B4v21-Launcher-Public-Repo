...
public:
	...
	/// Called when this object is set to be visible
	virtual bool OnVisible();

	/// Called when this object is set to be invisible
    ...
    void renderJustifiedText(Point2I offset, Point2I extent, const char *text, ColorI* fontOutlineColor = NULL);
