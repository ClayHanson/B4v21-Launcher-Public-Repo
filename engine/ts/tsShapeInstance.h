...
class TSShapeInstance
{
   ...
   /// @name Node customizing
   /// @{

   BitVector nodeVisibility;
   Vector<ColorI> nodeColors;
...
//-------------------------------------------------------------------------------------
   ...
   ColorI getNodeColor(const char* name);
   bool setNodeColor(const char* name, ColorI color);
   bool setNodeColor(S32 index, ColorI color);
   void updateNodeColors();

   bool setNodeVisible(const char* name, bool val);
   bool isNodeVisible(const char* name);
   bool isNodeVisible(S32 index);
