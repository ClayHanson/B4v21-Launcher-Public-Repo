...
struct Platform
{
   ...
   static char* getWindowTitle( char* pBuffer, int iMaxSize );
   ...
   static const Point2I& getWindowPosition();
   static void setWindowPosition(U32 newX, U32 newY);
...
public:
   ...
   static bool dumpPath(const char *in_pBasePath, Vector<FileInfo>& out_rFileVector, S32 recurseDepth = -1, const char* in_pPattern = "*");
...
extern long int	   dStrtol(const char *str1, char **endptr, int base);
